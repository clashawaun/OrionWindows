...
namespace OrionWindowsDesktop
{
    ...
    public class Orion : IOrion
    {
        ...
        /// </summary>
        /// <returns>
        /// The <see cref="AuthenticationController"/>.
        /// </returns>
        ...
        /// <summary>
        /// Create a organisation controller with the current context.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Method to set context config with default values
        /// </summary>
        /// <param name="config">
        /// The config.
        /// </param>
